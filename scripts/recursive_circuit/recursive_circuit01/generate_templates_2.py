...
getItemSize = lambda l : sum([x[2] for x in l])

circle_info = [
        ('center', 'Vector2', 2*4*8),
        ('radius', 'float', 4*8)]

interval_info = [
        ('start_time', 'float', 4*8),
        ('end_time', 'float', 4*8)]
...
cluster_keyframe = [
        ('start_territory', 'Rectangle', 4*4*8),
        ('end_territory', 'Rectangle', 4*4*8),
        ('interval', 'IntervalInfo', getItemSize(interval_info))]

entry_node = [
        ('node_info', 'NodeInfo', getItemSize(node_info))]
...
entry_node_keyframe = [
        ('start_territory', 'CircleInfo', getItemSize(circle_info)),
        ('end_territory', 'CircleInfo', getItemSize(circle_info)),
        ('interval', 'IntervalInfo', getItemSize(interval_info))]
