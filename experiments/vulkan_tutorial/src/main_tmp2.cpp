...
private:
  ...
  void drawFrame(VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
    ...
    if (result == VK_ERROR_OUT_OF_DATE_KHR) {
      recreateSwapChainForPresentableDevice(
          ...
          depthImageView, swapChainImageFormat, extent, renderPass,
  ...
  void drawFrame2(
      ...
      VkImageView &imageView_unp, VkImageView &depthImageView_unp,
    ...
    if (result == VK_ERROR_OUT_OF_DATE_KHR) {
      recreateSwapChainForPresentableDevice(
          ...
          swapChainImageViews_p, depthImageView_p, swapChainImageFormat_p,
          extent, renderPass_p, swapChainFrameBuffers_p);

      recreateFrameBufferforUnpresentableDevice(
          physicalDevice_unp, logicalDevice_unp, deviceQueueCommandUnitSet_unp,
          image_unp, imageMemory_unp, imageView_unp, depthImageView_unp,
    ...
    while (!glfwWindowShouldClose(window)) {
      ...
      if (!isSplitRenderPresentMode) {
        ...
        drawFrame2(
            ...
            unpresentableDeviceImageViews[0], unpresentableDepthImagesViews[0],
            presentableSwapChainImageFormat, unpresentableRenderPasses[0],
            unpresentableGraphicsPipelines[0],
