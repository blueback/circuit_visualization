...
struct DeviceQueueSet {
  ...
  union {
    ...
    } presentable_device_all_three_seperate_queue_index_set;
    struct {
      int graphicsQueueIndex;
      int presentAndTransferQueueIndex;
    } presentable_device_graphics_seperate_queue_index_set;
    struct {
      int presentQueueIndex;
      int graphicsAndTransferQueueIndex;
    } presentable_device_present_seperate_queue_index_set;
    struct {
      int transferQueueIndex;
      int graphicsAndPresentQueueIndex;
    } presentable_device_transfer_seperate_queue_index_set;
    struct {
      int unifiedQueueIndex;
    } presentable_device_all_three_same_queue_index_set;
    struct {
      int graphicsQueueIndex;
      int transferQueueIndex;
    } unpresentable_device_seperate_queue_index_set;
    struct {
      int graphicsAndTransferQueueIndex;
    } unpresentable_device_same_queue_index_set;
  } queue_index_set;
  union {
    struct {
    ...
    } presentable_device_all_three_seperate_queue_set;
    struct {
      VkQueue graphicsQueue;
      VkQueue presentAndTransferQueue;
    } presentable_device_graphics_seperate_queue_set;
    struct {
      VkQueue presentQueue;
      VkQueue graphicsAndTransferQueue;
    } presentable_device_present_seperate_queue_set;
    struct {
      VkQueue transferQueue;
      VkQueue graphicsAndPresentQueue;
    } presentable_device_transfer_seperate_queue_set;
    struct {
      VkQueue unifiedQueue;
    } presentable_device_all_three_same_queue_set;
    struct {
      VkQueue graphicsQueue;
      VkQueue transferQueue;
    } unpresentable_device_seperate_queue_set;
    struct {
      VkQueue graphicsAndTransferQueue;
    } unpresentable_device_same_queue_set;
  } queue_set;
  ...
  static bool checkAndFillPresentableDeviceAllThreeSeperateQueueIndexSet(
    ...
    if (graphicsQueueIndex.has_value() && transferQueueIndex.has_value() &&
      ...
      deviceQueueSet.type =
          DeviceQueueSet::PRESENTABLE_DEVICE_ALL_THREE_SEPERATE_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set
          .presentable_device_all_three_seperate_queue_index_set = {
          .graphicsQueueIndex = graphicsQueueIndex.value(),
          .presentQueueIndex = presentQueueIndex.value(),
          .transferQueueIndex = transferQueueIndex.value()};
      return true;
    }
  ...
  static bool checkAndFillPresentableDeviceGraphicsSeperateQueueIndexSet(
    ...
    if (presentAndTransferQueueIndex.has_value() &&
      ...
      deviceQueueSet.type =
          DeviceQueueSet::PRESENTABLE_DEVICE_GRAPHICS_SEPERATE_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set
          .presentable_device_graphics_seperate_queue_index_set = {
          .graphicsQueueIndex = graphicsSeperateQueueIndex.value(),
          .presentAndTransferQueueIndex = presentAndTransferQueueIndex.value()};
      return true;
    }
    return false;
  }
  ...
  static bool checkAndFillPresentableDeviceTransferSeperateQueueIndexSet(
    ...
    if (graphicsAndPresentQueueIndex.has_value() &&
      ...
      deviceQueueSet.type =
          DeviceQueueSet::PRESENTABLE_DEVICE_TRANSFER_SEPERATE_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set
          .presentable_device_transfer_seperate_queue_index_set = {
          .transferQueueIndex = transferSeperateQueueIndex.value(),
          .graphicsAndPresentQueueIndex = graphicsAndPresentQueueIndex.value()};
      return true;
    }
    return false;
  }
  ...
  static bool checkAndFillPresentableDevicePresentSeperateQueueIndexSet(
    ...
    if (graphicsAndTransferQueueIndex.has_value() &&
      ...
      deviceQueueSet.type =
          DeviceQueueSet::PRESENTABLE_DEVICE_PRESENT_SEPERATE_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set
          .presentable_device_present_seperate_queue_index_set = {
          .presentQueueIndex = presentSeperateQueueIndex.value(),
          .graphicsAndTransferQueueIndex =
  ...
  static bool checkAndFillPresentableDeviceAllThreeSameQueueIndexSet(
    ...
    if (unifiedQueueIndex.has_value()) {
      deviceQueueSet.type =
          DeviceQueueSet::PRESENTABLE_DEVICE_ALL_THREE_SAME_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set
          .presentable_device_all_three_same_queue_index_set.unifiedQueueIndex =
  ...
  static bool checkAndFillUnpresentableDeviceSeperateQueueIndexSet(
    ...
    if (graphicsQueueIndex.has_value() && transferQueueIndex.has_value()) {
      deviceQueueSet.type =
          DeviceQueueSet::UNPRESENTABLE_DEVICE_SEPERATE_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set
          .unpresentable_device_seperate_queue_index_set = {
          .graphicsQueueIndex = graphicsQueueIndex.value(),
          .transferQueueIndex = transferQueueIndex.value()};
  ...
  static bool checkAndFillUnpresentableDeviceSameQueueIndexSet(
    ...
    if (unifiedQueueIndex.has_value()) {
      deviceQueueSet.type =
          DeviceQueueSet::UNPRESENTABLE_DEVICE_SAME_QUEUE_SET_TYPE;
      deviceQueueSet.queue_index_set.unpresentable_device_same_queue_index_set
          .graphicsAndTransferQueueIndex = unifiedQueueIndex.value();
      return true;
    }
  ...
  static void decideAndFillQueueSetIndices(VkPhysicalDevice physicalDevice,
  ...
  getUniqueQueueFamiliesIndices(const DeviceQueueSet &deviceQueueSet) {
    std::vector<uint32_t> uniqueQueueFamiliesArray;

    switch (deviceQueueSet.type) {
    case DeviceQueueSet::PRESENTABLE_DEVICE_ALL_THREE_SEPERATE_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_all_three_seperate_queue_index_set
              .graphicsQueueIndex);
      uniqueQueueFamiliesArray.push_back(
    ...
    case DeviceQueueSet::PRESENTABLE_DEVICE_GRAPHICS_SEPERATE_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_graphics_seperate_queue_index_set
              .graphicsQueueIndex);
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_graphics_seperate_queue_index_set
              .presentAndTransferQueueIndex);
      break;
    }
    case DeviceQueueSet::PRESENTABLE_DEVICE_PRESENT_SEPERATE_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_present_seperate_queue_index_set
              .presentQueueIndex);
    ...
    case DeviceQueueSet::PRESENTABLE_DEVICE_TRANSFER_SEPERATE_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_transfer_seperate_queue_index_set
              .transferQueueIndex);
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_transfer_seperate_queue_index_set
              .graphicsAndPresentQueueIndex);
      break;
    }
    case DeviceQueueSet::PRESENTABLE_DEVICE_ALL_THREE_SAME_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .presentable_device_all_three_same_queue_index_set
              .unifiedQueueIndex);
    ...
    case DeviceQueueSet::UNPRESENTABLE_DEVICE_SEPERATE_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .unpresentable_device_seperate_queue_index_set
              .graphicsQueueIndex);
    ...
    case DeviceQueueSet::UNPRESENTABLE_DEVICE_SAME_QUEUE_SET_TYPE: {
      uniqueQueueFamiliesArray.push_back(
          deviceQueueSet.queue_index_set
              .unpresentable_device_same_queue_index_set
              .graphicsAndTransferQueueIndex);
  ...
  static void fetchAndFillDeviceQueueSet(VkDevice logicalDevice,
                                         DeviceQueueSet &deviceQueueSet) {
    switch (deviceQueueSet.type) {
    case DeviceQueueSet::PRESENTABLE_DEVICE_ALL_THREE_SEPERATE_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
      ...
      vkGetDeviceQueue(
          ...
          0,
          &(deviceQueueSet.queue_set
                .presentable_device_all_three_seperate_queue_set.presentQueue));
    ...
    case DeviceQueueSet::PRESENTABLE_DEVICE_GRAPHICS_SEPERATE_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
          ...
          0,
          &(deviceQueueSet.queue_set
                .presentable_device_graphics_seperate_queue_set.graphicsQueue));
    ...
    case DeviceQueueSet::PRESENTABLE_DEVICE_PRESENT_SEPERATE_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
          ...
          0,
          &(deviceQueueSet.queue_set
                .presentable_device_present_seperate_queue_set.presentQueue));
    ...
    case DeviceQueueSet::PRESENTABLE_DEVICE_TRANSFER_SEPERATE_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
          ...
          0,
          &(deviceQueueSet.queue_set
                .presentable_device_transfer_seperate_queue_set.transferQueue));
    ...
    case DeviceQueueSet::PRESENTABLE_DEVICE_ALL_THREE_SAME_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
          ...
          deviceQueueSet.queue_index_set
              ...
              .unifiedQueueIndex,
          0,
          &(deviceQueueSet.queue_set.presentable_device_all_three_same_queue_set
                .unifiedQueue));
      break;
    }
    case DeviceQueueSet::UNPRESENTABLE_DEVICE_SEPERATE_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
          logicalDevice,
          deviceQueueSet.queue_index_set
              .unpresentable_device_seperate_queue_index_set.graphicsQueueIndex,
          0,
          &(deviceQueueSet.queue_set.unpresentable_device_seperate_queue_set
                .graphicsQueue));

      vkGetDeviceQueue(
          logicalDevice,
          deviceQueueSet.queue_index_set
              .unpresentable_device_seperate_queue_index_set.transferQueueIndex,
          0,
          &(deviceQueueSet.queue_set.unpresentable_device_seperate_queue_set
                .transferQueue));
      break;
    ...
    case DeviceQueueSet::UNPRESENTABLE_DEVICE_SAME_QUEUE_SET_TYPE: {
      vkGetDeviceQueue(
          ...
          deviceQueueSet.queue_index_set
              ...
              .graphicsAndTransferQueueIndex,
          0,
          &(deviceQueueSet.queue_set.unpresentable_device_same_queue_set
                .graphicsAndTransferQueue));
      break;
    }
    }
...
struct DeviceCommandPoolsAndBuffers {
  union {
    struct {
      int graphicsQueueCommandPool;
      int presentQueueCommandPool;
      int transferQueueCommandPool;
    } presentable_device_all_three_seperate_queue_command_set;
    struct {
      int graphicsQueueCommandPool;
      int presentAndTransferQueueCommandPool;
    } presentable_device_graphics_seperate_queue_command_set;
    struct {
      int presentQueueCommandPool;
      int graphicsAndTransferQueueCommandPool;
    } presentable_device_present_seperate_queue_command_set;
    struct {
      int transferQueueCommandPool;
      int graphicsAndPresentQueueCommandPool;
    } presentable_device_transfer_seperate_queue_command_set;
    struct {
      int unifiedQueueCommandPool;
    } presentable_device_all_three_same_queue_command_set;
    struct {
      int graphicsQueueCommandPool;
      int transferQueueCommandPool;
    } unpresentable_device_seperate_queue_command_set;
    struct {
      int graphicsAndTransferQueueCommandPool;
    } unpresentable_device_same_queue_command_set;
  } queue_command_set;
};
...
private:
  ...
  DeviceQueueSet presentableDeviceQueueSet;
  ...
  VkCommandPool presentableGraphicsQueueCommandPool;
  std::vector<VkCommandBuffer> presentableGraphicsQueueCommandBuffers;

  VkCommandPool presentableTransferQueueCommandPool;
  std::vector<VkCommandBuffer> presentableTransferQueueCommandBuffers;

  VkCommandPool presentablePresentQueueCommandPool;
  std::vector<VkCommandBuffer> presentablePresentQueueCommandBuffers;
  ...
  std::vector<DeviceQueueSet> unpresentableDeviceQueueSet;
  ...
  std::vector<VkCommandPool> unpresentableGraphicsQueueCommandPools;
  std::vector<std::vector<VkCommandBuffer>>
      unpresentableGraphicsQueueCommandBuffers;

  std::vector<VkCommandPool> unpresentableTransferQueueCommandPools;
  std::vector<std::vector<VkCommandBuffer>>
      unpresentableTransferQueueCommandBuffers;
...
private:
  ...
  static bool isDeviceSuitable(VkPhysicalDevice device) {
    ...
    */
    ...
    if (!DeviceQueueSet::isGraphicsQueueSupportedByPhysicalDevice(device)) {
      return false;
    }

    if (!DeviceQueueSet::isTransferQueueSupportedByPhysicalDevice(device)) {
      return false;
    }
    ...
    forEachAvailablePhysicalDevice(instance, [&](VkPhysicalDevice device) {
      ...
      if (isGeometryShaderSupportedByPhysicalDevice(device)) {
        if (!presentablePhysicalDevice &&
            DeviceQueueSet::isPhysicalDevicePresentable(device,
                                                        windowSurface) &&
  ...
  static void createLogicalDevice(VkPhysicalDevice physicalDevice,
    ...
    DeviceQueueSet::decideAndFillQueueSetIndices(physicalDevice, windowSurface,
                                                 deviceQueueSet);

    std::vector<uint32_t> uniqueQueueFamiliesArray =
        DeviceQueueSet::getUniqueQueueFamiliesIndices(deviceQueueSet);
    ...
    DeviceQueueSet::fetchAndFillDeviceQueueSet(logicalDevice, deviceQueueSet);
  ...
  static void createBuffer(VkPhysicalDevice physicalDevice,
                           VkDevice logicalDevice,
                           const DeviceQueueSet &deviceQueueSet,
                           VkDeviceSize bufferSize,
  ...
  static void createImage(VkPhysicalDevice physicalDevice,
                          VkDevice logicalDevice,
                          const DeviceQueueSet &deviceQueueSet, uint32_t width,
  ...
  static void createSwapChainForPresentation(
      ...
      const DeviceQueueSet &deviceQueueSet, GLFWwindow *window,
      VkSurfaceKHR windowSurface, const bool isImageTransferDestination,
  ...
  static void createUnpresentableDeviceImage(
      VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
      const DeviceQueueSet &deviceQueueSet, uint32_t width, uint32_t height,
      VkFormat format, VkImage &image, VkDeviceMemory &imageMemory) {

    createImage(
        physicalDevice, logicalDevice, deviceQueueSet, width, height, format,
  ...
  static void createGraphicsQueueCommandPoolAndBuffers(
      VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
      VkCommandPool &commandPool,
      std::vector<VkCommandBuffer> &commandBuffers) {

    createCommandPool(physicalDevice, logicalDevice,
                      getGraphicsQueueFamilyIndex(physicalDevice), commandPool);

    createCommandBuffers(physicalDevice, logicalDevice, commandPool,
                         commandBuffers);
  }

  static void createPresentQueueCommandPoolAndBuffers(
      VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
      VkSurfaceKHR windowSurface, VkCommandPool &commandPool,
      std::vector<VkCommandBuffer> &commandBuffers) {
  ...
  static void createTransferQueueCommandPoolAndBuffers(
      VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
      VkCommandPool &commandPool,
      std::vector<VkCommandBuffer> &commandBuffers) {

    createCommandPool(physicalDevice, logicalDevice,
                      getTransferQueueFamilyIndex(physicalDevice), commandPool);
  ...
  static void createVertexBuffer(VkPhysicalDevice physicalDevice,
    ...
    createBuffer(physicalDevice, logicalDevice, deviceQueueSet, bufferSize,
  ...
  static void createCommandPoolsAndBuffersForPresentableDevice(
      VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
      VkSurfaceKHR windowSurface, VkCommandPool &graphicsQueueCommandPool,
    ...
    createGraphicsQueueCommandPoolAndBuffers(physicalDevice, logicalDevice,
                                             graphicsQueueCommandPool,
                                             graphicsQueueCommandBuffers);

    createTransferQueueCommandPoolAndBuffers(physicalDevice, logicalDevice,
                                             transferQueueCommandPool,
                                             transferQueueCommandBuffers);

    createPresentQueueCommandPoolAndBuffers(
        physicalDevice, logicalDevice, windowSurface, presentQueueCommandPool,
        presentQueueCommandBuffers);
  }

  static void destroyCommandPoolsAndBuffersForPresentableDevice(
      VkDevice logicalDevice, VkCommandPool &graphicsQueueCommandPool,
      VkCommandPool &transferQueueCommandPool,
      VkCommandPool &presentQueueCommandPool) {

    vkDestroyCommandPool(logicalDevice, graphicsQueueCommandPool, nullptr);

    vkDestroyCommandPool(logicalDevice, transferQueueCommandPool, nullptr);

    vkDestroyCommandPool(logicalDevice, presentQueueCommandPool, nullptr);
  }

  static void createCommandPoolsAndBuffersForUnpresentableDevice(
      VkPhysicalDevice physicalDevice, VkDevice logicalDevice,
  ...
  static void destroyCommandPoolsAndBuffersForUnpresentableDevice(
      VkDevice logicalDevice, VkCommandPool &graphicsQueueCommandPool,
      VkCommandPool &transferQueueCommandPool) {
  ...
  static void createStagingBuffer(VkPhysicalDevice physicalDevice,
    ...
    createBuffer(physicalDevice, logicalDevice, bufferSize, bufferUsage,
                 VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
                     VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
  ...
  void initVulkan() {
    ...
    fetchGraphicsQueue(presentablePhysicalDevice, presentableLogicalDevice,
                       graphicsQueueForPresentable);

    fetchTransferQueue(presentablePhysicalDevice, presentableLogicalDevice,
                       transferQueueForPresentable);

    fetchPresentationQueue(presentablePhysicalDevice, presentableLogicalDevice,
                           presentableWindowSurface,
    ...
    createCommandPoolsAndBuffersForPresentableDevice(
        presentablePhysicalDevice, presentableLogicalDevice,
        presentableWindowSurface, presentableGraphicsQueueCommandPool,
        presentableGraphicsQueueCommandBuffers,
        presentableTransferQueueCommandPool,
        presentableTransferQueueCommandBuffers,
        presentablePresentQueueCommandPool,
        presentablePresentQueueCommandBuffers);
    ...
    transferQueuesForUnpresentable.resize(unpresentablePhysicalDevices.size());
    ...
    unpresentableGraphicsQueueCommandPools.resize(
        unpresentablePhysicalDevices.size());
    unpresentableGraphicsQueueCommandBuffers.resize(
        unpresentablePhysicalDevices.size());

    unpresentableTransferQueueCommandPools.resize(
        unpresentablePhysicalDevices.size());
    unpresentableTransferQueueCommandBuffers.resize(
        unpresentablePhysicalDevices.size());
    ...
    for (uint32_t i = 0; i < unpresentablePhysicalDevices.size(); i++) {
      ...
      fetchGraphicsQueue(unpresentablePhysicalDevices[i],
                         unpresentableLogicalDevices[i],
                         graphicsQueuesForUnpresentable[i]);

      fetchTransferQueue(unpresentablePhysicalDevices[i],
                         unpresentableLogicalDevices[i],
                         transferQueuesForUnpresentable[i]);
      ...
      createCommandPoolsAndBuffersForUnpresentableDevice(
          unpresentablePhysicalDevices[i], unpresentableLogicalDevices[i],
          unpresentableGraphicsQueueCommandPools[i],
          unpresentableGraphicsQueueCommandBuffers[i],
          unpresentableTransferQueueCommandPools[i],
          unpresentableTransferQueueCommandBuffers[i]);
  ...
  void drawFrame2(
      ...
      VkQueue graphicsQueue_unp, VkQueue transferQueue_unp, VkImage &image_unp,
      ...
      std::vector<VkCommandBuffer> &graphicsQueueCommandBuffers_unp,
      std::vector<VkCommandBuffer> &transferQueueCommandBuffers_unp,
      ...
      VkPhysicalDevice physicalDevice_p, VkDevice logicalDevice_p,
      VkQueue graphicsQueue_p, VkQueue transferQueue_p, VkQueue presentQueue_p,
      ...
      std::vector<VkCommandBuffer> &transferQueueCommandBuffers_p,
      std::vector<VkCommandBuffer> &presentQueueCommandBuffers_p,
  ...
  void mainLoop() {
    while (!glfwWindowShouldClose(window)) {
      ...
      drawFrame(
          presentablePhysicalDevice, presentableLogicalDevice,
          graphicsQueueForPresentable, presentationQueueForPresentable, window,
          ...
          presentableGraphicsPipeline, presentableGraphicsQueueCommandBuffers,
      ...
      drawFrame2(
          ...
          graphicsQueuesForUnpresentable[0], transferQueuesForUnpresentable[0],
          ...
          unpresentableDeviceFrameBuffers[0],
          unpresentableGraphicsQueueCommandBuffers[0],
          unpresentableTransferQueueCommandBuffers[0],
          unpresentableVertexBuffers[0],
          ...
          transferQueueForPresentable, presentationQueueForPresentable, window,
          presentableWindowSurface, presentableSwapChain,
          presentableSwapChainImages, presentableSwapChainImageViews,
          presentableSwapChainImageFormat, presentableSwapChainExtent,
          presentableRenderPass, presentableSwapChainFrameBuffers,
  ...
  void cleanup() {
    ...
    for (uint32_t i = 0; i < unpresentableDeviceImages.size(); i++) {
      ...
      destroyCommandPoolsAndBuffersForUnpresentableDevice(
          unpresentableLogicalDevices[i],
          unpresentableGraphicsQueueCommandPools[i],
          unpresentableTransferQueueCommandPools[i]);
    ...
    destroyCommandPoolsAndBuffersForPresentableDevice(
        presentableLogicalDevice, presentableGraphicsQueueCommandPool,
        presentableTransferQueueCommandPool,
        presentablePresentQueueCommandPool);
